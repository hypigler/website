...
function useTransition({
  ...
  const timeoutRef = (0, import_react136.useRef)(-1);
...
// node_modules/@mantine/core/esm/components/Loader/loaders/Bars.mjs
var Bars = (0, import_react146.forwardRef)(({ className, ...others }, ref) => (0, import_jsx_runtime64.jsxs)(Box, { component: "span", className: clsx_default(classes6.barsLoader, className), ...others, ref, children: [
...
var Dots = (0, import_react147.forwardRef)(({ className, ...others }, ref) => (0, import_jsx_runtime65.jsxs)(Box, { component: "span", className: clsx_default(classes6.dotsLoader, className), ...others, ref, children: [
...
var Oval = (0, import_react148.forwardRef)(({ className, ...others }, ref) => (0, import_jsx_runtime66.jsx)(Box, { component: "span", className: clsx_default(classes6.ovalLoader, className), ...others, ref }));
...
var InputWrapper = factory((_props, ref) => {
  ...
  const _input = (0, import_jsx_runtime88.jsx)(import_react174.Fragment, { children: inputContainer(children) }, "input");
...
function useResizing({ transitionDuration, disabled }) {
  ...
  const resizingTimeout = (0, import_react207.useRef)();
  const disabledTimeout = (0, import_react207.useRef)();
...
var Breadcrumbs = factory((_props, ref) => {
  ...
  const items = import_react243.Children.toArray(children).reduce((acc, child, index5, array) => {
    var _a;
    const item = isElement(child) ? (0, import_react243.cloneElement)(child, {
      ...
      key: index5
    }) : (0, import_react243.createElement)("div", { ...getStyles2("breadcrumb"), key: index5 }, child);
    acc.push(item);
    if (index5 !== array.length - 1) {
      acc.push(
        (0, import_react243.createElement)(Box, { ...getStyles2("separator"), key: `separator-${index5}` }, separator)
      );
    }
    return acc;
  }, []);
...
var Card = polymorphicFactory((_props, ref) => {
  ...
  const _children = import_react249.Children.toArray(children);
...
var Thumb2 = (0, import_react257.forwardRef)(({ position, ...others }, ref) => (0, import_jsx_runtime169.jsx)(
  Box,
  {
    ref,
    __vars: {
...
var ColorSlider = factory((_props, ref) => {
  ...
  const theme = useMantineTheme();
  const [position, setPosition] = (0, import_react258.useState)({ y: 0, x: value / maxValue });
  ...
  const layers = overlays.map((overlay, index5) => (0, import_react258.createElement)("div", { ...getStyles2("sliderOverlay"), style: overlay, key: index5 }));
...
// node_modules/@mantine/core/esm/components/ColorPicker/AlphaSlider/AlphaSlider.mjs
var defaultProps77 = {};
var AlphaSlider = (0, import_react259.forwardRef)((props, ref) => {
...
var HueSlider = (0, import_react260.forwardRef)((props, ref) => {
...
function Saturation({
  ...
  const [position, setPosition] = (0, import_react261.useState)({ x: value.s / 100, y: 1 - value.v / 100 });
...
var Swatches = (0, import_react262.forwardRef)(
  ({
    className,
    datatype,
    setValue,
    ...
    const colors = data.map((color, index5) => (0, import_react262.createElement)(
      ColorSwatch,
      {
...
var ColorPicker = factory((_props, ref) => {
  ...
  const formatRef = (0, import_react263.useRef)(format2);
  const valueRef = (0, import_react263.useRef)();
  const scrubTimeoutRef = (0, import_react263.useRef)(-1);
  const isScrubbingRef = (0, import_react263.useRef)(false);
  ...
  const [parsed, setParsed] = (0, import_react263.useState)(parseColor(_value));
  const startScrubbing = () => {
...
var ColorInput = factory((_props, ref) => {
  ...
  const [dropdownOpened, setDropdownOpened] = (0, import_react264.useState)(false);
  const [lastValidValue, setLastValidValue] = (0, import_react264.useState)("");
  const [_value, setValue] = useUncontrolled({
    value,
    defaultValue,
    finalValue: "",
...
function useVirtualizedCombobox({
  ...
  const listId = (0, import_react265.useRef)(null);
  const searchRef = (0, import_react265.useRef)(null);
  const targetRef = (0, import_react265.useRef)(null);
  const focusSearchTimeout = (0, import_react265.useRef)(-1);
  const focusTargetTimeout = (0, import_react265.useRef)(-1);
  const openDropdown = () => {
    if (!dropdownOpened) {
      setDropdownOpened(true);
  ...
  const getSelectedOptionIndex = (0, import_react265.useCallback)(() => selectedOptionIndex, []);
  return {
    dropdownOpened,
    openDropdown,
    closeDropdown,
...
var FileButton = (0, import_react280.forwardRef)(
  (props, ref) => {
    const {
      onChange,
      children,
    ...
    const inputRef = (0, import_react280.useRef)();
    const onClick = () => {
      var _a;
...
var _FileInput = factory((_props, ref) => {
  ...
  const resetRef = (0, import_react281.useRef)(null);
  const [_value, setValue] = useUncontrolled({
    value,
    defaultValue,
    onChange,
...
function useDelayedHover({ open, close, openDelay, closeDelay }) {
  const openTimeout = (0, import_react282.useRef)(-1);
  const closeTimeout = (0, import_react282.useRef)(-1);
  const clearTimeouts = () => {
  ...
  (0, import_react282.useEffect)(() => clearTimeouts, []);
...
var HoverCardTarget = (0, import_react293.forwardRef)((props, ref) => {
  ...
  return (0, import_jsx_runtime204.jsx)(Popover.Target, { refProp, ref, ...others, children: (0, import_react293.cloneElement)(
    children,
...
var Image = polymorphicFactory((_props, ref) => {
  ...
  const [error2, setError] = (0, import_react296.useState)(!src);
  (0, import_react296.useEffect)(() => setError(!src), [src]);
  const getStyles2 = useStyles({
    name: "Image",
    classes: classes48,
    props,
...
var index3 = import_react299.useLayoutEffect;
...
var useComposedRef = function useComposedRef2(libRef, userRef) {
  var prevUserRef = (0, import_react300.useRef)();
  return (0, import_react300.useCallback)(function(instance) {
...
var JsonInput = factory((props, ref) => {
  ...
  const [valid, setValid] = (0, import_react302.useState)(validateJson(_value, deserialize));
...
var LoadingOverlay = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime215.jsx)(Transition, { transition: "fade", ...transitionProps, mounted: !!visible2, children: (transitionStyles) => (0, import_jsx_runtime215.jsxs)(Box, { ...getStyles2("root", { style: transitionStyles }), ref, ...others, children: [
...
var MenuDropdown = factory((props, ref) => {
  ...
  const wrapperRef = (0, import_react310.useRef)(null);
  const ctx = useMenuContext();
  const handleKeyDown = (event) => {
    var _a, _b;
...
var MenuItem = polymorphicFactory((props, ref) => {
  ...
  const theme = useMantineTheme();
  const { dir } = useDirection();
  const itemRef = (0, import_react311.useRef)();
...
var MenuTarget = (0, import_react313.forwardRef)((props, ref) => {
  ...
  return (0, import_jsx_runtime221.jsx)(Popover.Target, { refProp, popupType: "menu", ref, ...others, children: (0, import_react313.cloneElement)(children, {
    onClick,
    onMouseEnter,
    onMouseLeave,
...
function Menu(_props) {
  ...
  const [openedViaClick, setOpenedViaClick] = (0, import_react314.useState)(false);
  const close = () => {
    setOpened(false);
...
var PillsInput = factory((_props, ref) => {
  ...
  const fieldRef = (0, import_react330.useRef)();
...
function usePersistentCallback(cb) {
  var callbackRef = (0, import_react336.useRef)(cb);
  callbackRef.current = cb;
  var persistentCbRef = (0, import_react336.useRef)(function() {
    var args = [], len = arguments.length;
    while (len--)
      args[len] = arguments[len];
...
function useInternalValues(value, defaultValue, valueIsNumericString, format2, removeFormatting2, onValueChange) {
  ...
  var ref = (0, import_react336.useState)(function() {
  ...
  (0, import_react336.useMemo)(function() {
    setValues(newValues);
...
function NumberFormatBase(props) {
  ...
  var caretPositionBeforeChange = (0, import_react336.useRef)();
  var lastUpdatedValue = (0, import_react336.useRef)({ formattedValue, numAsString });
  ...
  var ref$1 = (0, import_react336.useState)(false);
  var mounted = ref$1[0];
  var setMounted = ref$1[1];
  var focusedElm = (0, import_react336.useRef)(null);
  var timeout = (0, import_react336.useRef)({
    setCaretTimeout: null,
    focusTimeout: null
  });
  (0, import_react336.useEffect)(function() {
    setMounted(true);
    return function() {
  ...
  var useIsomorphicLayoutEffect2 = typeof window !== "undefined" ? import_react336.useLayoutEffect : import_react336.useEffect;
  ...
  if (displayType === "text") {
    return renderText ? import_react336.default.createElement(import_react336.default.Fragment, null, renderText(formattedValue, otherProps) || null) : import_react336.default.createElement("span", Object.assign({}, otherProps, { ref: getInputRef }), formattedValue);
  } else if (customInput) {
    var CustomInput = customInput;
    return import_react336.default.createElement(CustomInput, Object.assign({}, inputProps, { ref: getInputRef }));
  }
  return import_react336.default.createElement("input", Object.assign({}, inputProps, { ref: getInputRef }));
}
...
function NumericFormat(props) {
  ...
  return import_react336.default.createElement(NumberFormatBase, Object.assign({}, numericFormatProps));
}
...
var NumberInput = factory((_props, ref) => {
  ...
  const inputRef = (0, import_react338.useRef)(null);
  const onStepTimeoutRef = (0, import_react338.useRef)(null);
  const stepCountRef = (0, import_react338.useRef)(0);
  ...
  const incrementRef = (0, import_react338.useRef)();
  ...
  const decrementRef = (0, import_react338.useRef)();
...
function createEdgeComponent({ icon, name, action, type }) {
  ...
  const Component = (0, import_react342.forwardRef)((props, ref) => {
  ...
  return (0, import_jsx_runtime257.jsxs)(import_jsx_runtime257.Fragment, { children: [
    (0, import_jsx_runtime257.jsx)(
      Group,
      {
        ...
        variant,
        __size: size4,
        children: _value.map((char, index5) => (0, import_react346.createElement)(
          Input,
          {
            component: "input",
            ...getStyles2("pinInput", {
...
var RingProgress = factory((_props, ref) => {
  ...
  const curves = getCurves({
    ...
    rootColor
  }).map(({ data, sum, root, lineRoundCaps, offset: offset4 }, index5) => (0, import_react373.createElement)(
    Curve,
    {
      ...data,
      key: index5,
...
var SegmentedControl = factory((_props, ref) => {
  ...
  const controls = _data.map((item) => (0, import_react374.createElement)(
    Box,
    {
      ...getStyles2("control"),
    ...
    (0, import_react374.createElement)(
      "input",
      {
        ...getStyles2("input"),
...
function useTree({
  ...
  const [expandedState, setExpandedState] = (0, import_react414.useState)(initialExpandedState);
  const [selectedState, setSelectedState] = (0, import_react414.useState)(initialSelectedState);
  const [anchorNode, setAnchorNode] = (0, import_react414.useState)(null);
  const [hoveredNode, setHoveredNode] = (0, import_react414.useState)(null);
  const initialize = (0, import_react414.useCallback)(
    (data) => {
      setExpandedState((current) => getInitialState(current, data, selectedState));
    },
    [selectedState]
  );
  const toggleExpanded = (0, import_react414.useCallback)((value) => {
    setExpandedState((current) => ({ ...current, [value]: !current[value] }));
  }, []);
  const collapse = (0, import_react414.useCallback)((value) => {
    setExpandedState((current) => ({ ...current, [value]: false }));
  }, []);
  const expand = (0, import_react414.useCallback)((value) => {
    setExpandedState((current) => ({ ...current, [value]: true }));
  }, []);
  const expandAllNodes = (0, import_react414.useCallback)(() => {
  ...
  const collapseAllNodes = (0, import_react414.useCallback)(() => {
    setExpandedState((current) => {
      const next = { ...current };
      Object.keys(next).forEach((key) => {
        next[key] = false;
  ...
  const toggleSelected = (0, import_react414.useCallback)(
...
var Tree = factory((_props, ref) => {
  ...
  const flatValues = (0, import_react415.useMemo)(() => getFlatValues(data), [data]);
